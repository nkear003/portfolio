<?php $__env->startSection('title', ' | Inner Symphony'); ?>
...
<div class="row">
    <div class="offset-by-one five columns">
        ...
        <img src="images/innersymphony/innersymphony-front-page.png" class="" alt="Inner Symphony | Front Page">
        <hr class="hrsmall no-show">
        <h2><a href="http://innersymphony.net/podcasts/" target="_blank">Podcasts Page</a>
        </h2>
        <img src="images/innersymphony/innersymphony-podcasts-page.png" class="" alt="Inner Symphony | Podcasts Page">
    </div>
