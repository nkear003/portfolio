...
<?php $__env->startSection('title', ' | Nicholas K Music'); ?>
...
<div class="row">
    <div class="offset-by-one ten columns">
        ...
        over the past few years. Above is a header I made to brand my various social media accounts and websites.
        Below are the covers I have made for my albums. Thus far I have traded a free download of music for an email address.
...
<div class="row">
    <div class="offset-by-one ten columns">
        <hr>
        <p>One of my favorite marketing strategies which I have implemented thus far, involves wrapping CDs
        containing my music in individually designed covers with a link to my website, and dispersing them throughout town,
        out in plain site, or tucked away. I call these “Weekend Mixtapes.”</p>
        <hr>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="offset-by-one ten columns">
        <hr>
        <p style="text-align: center">Below are a few examples of posters I have designed for shows I organized.</p>
        <hr>
    </div>
</div>
<div class="row">
...
<!---div class="row">
    <div class="offset-by-one ten columns">
        <hr>
        <p style="text-align: center">Finally, here are links to the social media accounts that I manage,
        as they appear on the <a href="http://music.nicholaskearney.com/" target="_blank">page.</a></p>
        <hr>                    
    </div>
</div>
<div class="row">
